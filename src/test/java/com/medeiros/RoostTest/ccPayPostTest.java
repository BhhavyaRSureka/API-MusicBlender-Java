...
public class ccPayPostTest {
    ...
    public void ccPay_post_Test() {  
        ...
        // Read CSV file  
        try (BufferedReader reader = new BufferedReader(new FileReader("src/test/java/com/medeiros/RoostTest/ccPayPostTest.csv"))) {  
            ...
            while ((line = reader.readLine()) != null) {  
				...
				.body("{\n"+
					...
					"  \"dueDate\": \"" + (map.get("dueDate") != null ? map.get("dueDate") : "") + "\n" +
 				"}")
