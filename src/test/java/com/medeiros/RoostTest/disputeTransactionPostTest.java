...
public class disputeTransactionPostTest {
    ...
    public void disputeTransaction_post_Test() {  
        ...
        // Read CSV file  
        try (BufferedReader reader = new BufferedReader(new FileReader("src/test/java/com/medeiros/RoostTest/disputeTransactionPostTest.csv"))) {  
            ...
            while ((line = reader.readLine()) != null) {  
				...
				.body("{\n"+
					...
					"  \"emailId\": \"" + (map.get("emailId") != null ? map.get("emailId") : "") + "\",\n" +
					"  \"transactionsData\": \"" + (map.get("transactionsData") != null ? map.get("transactionsData") : "") + "\n" +
 				"}")
