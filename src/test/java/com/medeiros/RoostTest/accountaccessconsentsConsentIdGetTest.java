...
Test generated for /account-access-consents/{ConsentId}_get for http method type GET in rest-assured framework

RoostTestHash=30fdbfbb44
...
public class accountaccessconsentsConsentIdGetTest {
  
    @Test  
    public void accountaccessconsentsConsentIdGet_Test() {  
        RestAssured.baseURI = System.getenv("BASE_URL");  
  
        // Read CSV file  
        try (BufferedReader reader = new BufferedReader(new FileReader("src" + File.separator + "test" + File.separator + "java" + File.separator + "com" + File.separator + "medeiros" + File.separator + "RoostTest" + File.separator + "account-access-consents_ConsentIdGetTest.csv"))) {  
            ...
            while ((line = reader.readLine()) != null) {  
                ...
                if (response.statusCode() == 200) {
					System.out.println("Description: Account Access Consents Read");
