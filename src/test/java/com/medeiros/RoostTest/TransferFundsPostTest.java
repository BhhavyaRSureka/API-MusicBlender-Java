...
public class TransferFundsPostTest {
    ...
    public void TransferFunds_post_Test() {  
        ...
        // Read CSV file  
        try (BufferedReader reader = new BufferedReader(new FileReader("src/test/java/com/medeiros/RoostTest/TransferFundsPostTest.csv"))) {  
            ...
            while ((line = reader.readLine()) != null) {  
				...
				.body("{\n"+
					...
					"  \"TransactionType\": \"" + (map.get("TransactionType") != null ? map.get("TransactionType") : "") + "\",\n" +
					"  \"PaymentType\": \"" + (map.get("PaymentType") != null ? map.get("PaymentType") : "") + "\n" +
 				"}")
