...
public class GetRecurringTransfersPostTest {
    ...
    @Test  
    public void GetRecurringTransfers_post_Test() {  
        RestAssured.baseURI = System.getenv("BASE_URL");  
  
        // Read CSV file  
        try (BufferedReader reader = new BufferedReader(new FileReader("src/test/java/com/medeiros/RoostTest/GetRecurringTransfersPostTest.csv"))) {  
            ...
            while ((line = reader.readLine()) != null) {  
              ...
              if (response.jsonPath().get("recurringOptions") != null) {    
              if (response.jsonPath().get("recurringOptions.amountType") != null) {
                MatcherAssert.assertThat(response.jsonPath().get("recurringOptions.amountType"), instanceOf(String.class));  
          }
    
              if (response.jsonPath().get("recurringOptions.frequency") != null) {    
              if (response.jsonPath().get("recurringOptions.frequency.duration") != null) {    
              if (response.jsonPath().get("recurringOptions.frequency.duration.untilStop") != null) {
                MatcherAssert.assertThat(response.jsonPath().get("recurringOptions.frequency.duration.untilStop"), instanceOf(String.class));  
          }
    
              if (response.jsonPath().get("recurringOptions.frequency.duration.untilDate") != null) {
                MatcherAssert.assertThat(response.jsonPath().get("recurringOptions.frequency.duration.untilDate"), instanceOf(String.class));  
          }
    
              if (response.jsonPath().get("recurringOptions.frequency.duration.numberOfPayments") != null) {
                MatcherAssert.assertThat(response.jsonPath().get("recurringOptions.frequency.duration.numberOfPayments"), instanceOf(String.class));  
          }
  
          }
    
              if (response.jsonPath().get("recurringOptions.frequency.iterate") != null) {
                MatcherAssert.assertThat(response.jsonPath().get("recurringOptions.frequency.iterate"), instanceOf(String.class));  
          }
