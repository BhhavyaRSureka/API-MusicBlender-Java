...
public class GetCCSchedulePostTest {
    ...
    @Test  
    public void GetCCSchedule_post_Test() {  
        RestAssured.baseURI = System.getenv("BASE_URL");  
  
        // Read CSV file  
        try (BufferedReader reader = new BufferedReader(new FileReader("src/test/java/com/medeiros/RoostTest/GetCCSchedulePostTest.csv"))) {  
