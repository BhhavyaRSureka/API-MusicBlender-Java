...
Test generated for /accounts/{AccountId}/statements/{StatementId}_get for http method type GET in rest-assured framework

RoostTestHash=96370d861e
...
public class statementsStatementIdGetTest {
  
    @Test  
    public void statementsStatementIdGet_Test() {  
        RestAssured.baseURI = System.getenv("BASE_URL");  
  
        // Read CSV file  
        try (BufferedReader reader = new BufferedReader(new FileReader("src" + File.separator + "test" + File.separator + "java" + File.separator + "com" + File.separator + "medeiros" + File.separator + "RoostTest" + File.separator + "statements_StatementIdGetTest.csv"))) {  
