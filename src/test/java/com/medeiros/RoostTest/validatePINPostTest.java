...
public class validatePINPostTest {
    ...
    @Test  
    public void validatePIN_post_Test() {  
        RestAssured.baseURI = System.getenv("BASE_URL");  
  
        // Read CSV file  
        try (BufferedReader reader = new BufferedReader(new FileReader("src/test/java/com/medeiros/RoostTest/validatePINPostTest.csv"))) {  
            ...
            while ((line = reader.readLine()) != null) {  
				...
				.body("{\n"+
					...
					"  \"profileInfo\": \"" + (map.get("profileInfo") != null ? map.get("profileInfo") : "") + "\n" +
 				"}")
