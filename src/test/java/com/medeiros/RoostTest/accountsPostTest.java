...
public class accountsPostTest {
    ...
    public void accounts_post_Test() {  
        ...
        // Read CSV file  
        try (BufferedReader reader = new BufferedReader(new FileReader("srcFile.separatortestFile.separatorjavaFile.separatorcomFile.separatormedeirosFile.separatorRoostTestFile.separatoraccountsPatchTest.csv"))) {  
